$(function(){
	...
	if (parauserId===""){
		$.getJSON("/user/session.do",function (data) {
			...
			$.getJSON("/getUserFollowedUserServlet.do",{userId:userId,index:1,pagesize:5},function (data){
			...
			function getPage(n){
				$.getJSON("/getUserFollowedUserServlet.do",{userId:userId,index:n,pagesize:5},function (data){
					if (data.success){
						var swiperHtml="";
	...
	} else
	{
		$.getJSON("/user/session.do",function (data){
			...
			if (parauserId != userId){
				...
				$.getJSON("/getUserFollowedUserServlet.do",{userId:parauserId,index:1,pagesize:5},function (data){
					if (data.success&&data.count!==0){
						$("#pagination").jqPaginator({
							totalPages: data.count,
							visiblePages: 5,
				...
				function getPage(n){
					$.getJSON("/getUserFollowedUserServlet.do",{userId:parauserId,index:n,pagesize:5},function (data){
						if (data.success){
							var swiperHtml="";
							var userList=data.userList;
							userList.map(function (item){
				...
				$.getJSON("/getUserFollowedUserServlet.do", {
					userId: parauserId,
					index: 1,
					pagesize: 5
				}, function (data) {
